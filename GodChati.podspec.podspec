#
#  Be sure to run `pod spec lint GodChati.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "ouyanggaojun" => "804716454@qq.com" }
  # Or just: spec.author    = "ouyanggaojun"
  # spec.authors            = { "ouyanggaojun" => "804716454@qq.com" }
  # spec.social_media_url   = "https://twitter.com/ouyanggaojun"
  ...
  spec.source       = { :git => "https://github.com/OuyangMumu/GodChati.git", :tag => spec.version }
